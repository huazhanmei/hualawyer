...
def make_authorization():
    ...
    _add_para(doc, "现委托上述受托人在本人（本单位）【案由】纠纷一案中，"
                   "作为我方委托诉讼代理人。")
...
def make_legal_rep():
    ...
    _add_para(doc, "【委托人名称】（统一社会信用代码：【统一社会信用代码】）"
                   "的法定代表人【法定代表人姓名】在我单位任职【法定代表人职务】，"
                   "系我单位法定代表人，特此证明。")
    _add_para(doc, "单位住所：【委托人住所】")
    _add_para(doc, "")
    _add_para(doc, "【年】年【月】月【日】日", indent=False)
    _add_para(doc, "（单位加盖公章）", align=WD_ALIGN_PARAGRAPH.RIGHT, indent=False)
